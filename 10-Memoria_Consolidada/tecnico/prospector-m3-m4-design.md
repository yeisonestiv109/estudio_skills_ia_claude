...
- `10-Memoria_Consolidada/tecnico/prospector-m1-m2-design.md` (arquitectura hexagonal base)
- `10-Memoria_Consolidada/flujos_motor_1_y_2.md` (`TriggerAggregationPolicy`, handoff a M3)
- `10-Memoria_Consolidada/modelos_dominio_core.md` (`Empresa`, `Decisor`, `EstadoCorreo`, enums)
- `10-Memoria_Consolidada/validacion/validacion-fuentes.md` §6 (pricing Apollo/Hunter, costo oculto 2–3×)

...
Propósito (ver `02_Lineas_de_Producto/Outbound_Prospector/docs/tecnico/prospector-m3-m4-design.md` §3.5):
...
# Fuente de referencia: 02_Lineas_de_Producto/Outbound_Prospector/docs/validacion/validacion-fuentes.md §6.

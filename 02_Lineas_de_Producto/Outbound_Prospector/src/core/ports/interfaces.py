...
Transcripción fiel de `02_Lineas_de_Producto/Outbound_Prospector/docs/modelos_dominio_core.md` (sección 6).
...
class PuertoEnriquecedorContactos(ABC):
    ...
    def enriquecer(self, empresa: Empresa, cargos: list[str]) -> list[Decisor]:
        ...
        en 02_Lineas_de_Producto/Outbound_Prospector/docs/tecnico/prospector-m3-m4-design.md §3.2).

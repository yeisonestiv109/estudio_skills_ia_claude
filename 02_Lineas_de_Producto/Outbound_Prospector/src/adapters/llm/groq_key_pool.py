...
class GroqKeyPool:
    ...
    def _descubrir_del_entorno() -> list[str]:
        ...
        Descubre claves en este orden:
            1. GROQ_API_KEY_1..GROQ_API_KEY__MAX — recolecta TODAS las presentes,
               TOLERANDO HUECOS en la numeración (fix 25-jul-2026: antes se
               detenía en el primer hueco, así que añadir GROQ_API_KEY_4 sin tener
               la _3 dejaba la clave nueva sin usarse silenciosamente).
        ...
        for i in range(1, _MAX_CLAVES_ENTORNO + 1):
            ...
            if valor:  # recolecta todas; NO se detiene en huecos
                claves.append(valor)

...
- `02_Lineas_de_Producto/Outbound_Prospector/docs/tecnico/prospector-m1-m2-design.md` (arquitectura hexagonal, frontera de costo)
- `02_Lineas_de_Producto/Outbound_Prospector/docs/tecnico/prospector-m3-m4-design.md` (contrato de transición, UmbralCalidadDecisor, KPI §3.5)
- `02_Lineas_de_Producto/Outbound_Prospector/docs/modelos_dominio_core.md` (`Decisor`, `EstadoCorreo`, `AutoridadDecision`, `Seniority`)
- `02_Lineas_de_Producto/Outbound_Prospector/docs/validacion/validacion-fuentes.md` §6 (pricing Tavily/LLM), §7 (Habeas Data, cold email)

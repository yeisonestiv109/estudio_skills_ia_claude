...
class ManifiestoICP(BaseModel):
    ...
    anclaje_tecnologico: list[str] = Field(
        ...
        description=(
            ...
            "Automatización, Tecnología, Software, Sistemas, Soluciones, Plataforma. "
            "Si el texto NO menciona ninguna tecnología concreta, devuelve una lista vacía: []. "
    ...
    tamano_empresa: TamanoEmpresa | None = Field(
        default=None,
        description="Tamaño de la empresa objetivo. Dejar como null si el usuario no especifica el tamaño o número de empleados.",
    )
